    ...
    <div class="box">
        <div class="box-body">
            ...
            @if($ruta->rutaCUMPLIMIENTO == 100)
                <h1 class="text-center">¡Felicitaciones!, ha completato su ruta de crecimiento</h1>
                @if($iniciarRuta == 'Si')
            ...
            success: function(data){
                ...
                if(data.status == 'OK'){
                    ...
                    if(data.cumplimiento == 100){
                        ...
                        $('#cumplimiento').html('');
                        $('#cumplimiento').html('<h1 class="text-center">¡Felicitaciones!, ha completato su ruta de crecimiento, puede iniciar un nuevo diagnóstico</h1>')
                    }
                }
