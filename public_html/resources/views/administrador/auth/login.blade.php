        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ action('Admin\Auth\LoginController@login') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('usuarioEMAIL') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="usuarioEMAIL" type="email" class="form-control" name="usuarioEMAIL" value="{{ old('usuarioEMAIL') }}" required autofocus>
