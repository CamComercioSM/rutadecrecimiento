<div class="box-body">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <div class="form-group has-feedback">
	        	<input class="form-control" type="text" name="representante_legal" id="representante_legal" placeholder="Representante legal" value="{{$usuario->datoUsuario->dato_usuarioTIPO_IDENTIFICACION}} - {{$usuario->datoUsuario->dato_usuarioIDENTIFICACION}} - {{$usuario->datoUsuario->dato_usuarioNOMBRE_COMPLETO}}" disabled>
