    ...
    <div class="my-5 mt-5 d-flex flex-column" id="register">
        <div class="row mt-5 justify-content-center">
            <div class="col-12 my-2 text-center">
                <?php if($companies->where('etapa_intervencion', '!=', 'TRANSFORMADA')->isEmpty()): ?>
...
<?php if($show_complete_registration_modal): ?>
...
$(document).ready(function() {
    ...
    $('#submitRegistrationBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("google.complete-registration.modal")); ?>',
            method: 'POST',
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpllinas\Documents\DesarrolloWEB\VPS-RUTAC\APP\rutadecrecimiento\resources\views/website/company/select_company.blade.php ENDPATH**/ ?>