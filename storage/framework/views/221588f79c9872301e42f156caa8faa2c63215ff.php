            ...
            <form id="frm_completardiagnostico" method="post" action="<?php echo e(route('company.diagnostic.save')); ?>">
                ...
                <?php $__currentLoopData = $preguntas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pregunta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <section id="variable-<?php echo e($pregunta->pregunta_id); ?>" class="variable hidden">
                        ...
                        <h4 class="color-2 font-w-700" style="font-size: 14px;color: #0c1892EE;"><?php echo e($pregunta->pregunta_desc); ?></h4>
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jpllinas\Documents\DesarrolloWEB\VPS-RUTAC\APP\rutadecrecimiento\resources\views/website/company/diagnostic.blade.php ENDPATH**/ ?>