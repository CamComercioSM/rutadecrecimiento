...
<div id="home">
    <section class="banner swiper" tabindex="4">
        <ul class="swiper-wrapper">
            ...
            <li class="swiper-slide" style="background-image: url('<?php echo e(asset('storage/'.$banner->image)); ?>')">
    ...
    <section class="company margin-section">
        <div class="wrap wrap-small">
            ...
            <ul class="mt-40">
                ...
                <li style="background-image: url('<?php echo e(asset('storage/'.$history->image)); ?>')" tabindex="11">
    ...
    <section class="briefcase margin-section">
        <div class="wrap wrap-medium" style="background-image: url('<?php echo e(asset('storage/'.$data->discover_bg_image)); ?>')">
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dir-CIDS\Documents\Repos\rutaCGitHUB\rutadecrecimiento\resources\views/website/home.blade.php ENDPATH**/ ?>