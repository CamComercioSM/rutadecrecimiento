<section class="w-100 hidden" id="matriculaFormal">
    ...
    <form class="row" id="matriculaFormalForm">
        ...
        <div class="col-12 col-md-6 form-group mb-3">
            ...
            <input type="text" class="form-control" id="nit_registrado" name="nit_registrado"
                placeholder="Ingrese el NIT sin dígito de verificación" maxlength="10" required />

            <small class="form-text text-muted">
                Ingrese únicamente el número base del NIT, sin dígito de verificación,
                sin puntos, comas ni caracteres especiales.
            </small>
        </div>
        ...
        <div class="col-12 col-md-12 form-group mb-3 name_legal_representative">
            ...
            <input type="text" class="form-control" placeholder="Respresentante Legal"
                name="name_legal_representative" id="name_legal_representative" required />
        </div>
...
<script>
    document.getElementById("nit_registrado").addEventListener("input", function(e) {

        // Eliminar todo lo que no sea número
        this.value = this.value.replace(/[^0-9]/g, '');

        // Limitar a máximo 10 dígitos (sin dígito de verificación)
...
<?php /**PATH C:\Users\jpllinas\Documents\DesarrolloWEB\VPS-RUTAC\APP\rutadecrecimiento\resources\views/website/register/parciales/matriculaFormal.blade.php ENDPATH**/ ?>