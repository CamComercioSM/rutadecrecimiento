<section class="w-100 hidden" id="tipoRegistro">
                    ...
                    <li>
                        ...
                        <label class="radio animated-border-box_encendido" style="">
                            ...
                            <div class="float-end icono_opcion_registro">
                                <img src="<?php echo e(asset('img/registro/registrado_ccsm.png')); ?>" alt="registrado_ccsm"
                                     class="" />
                            </div>
                        </label>
                    </li>
    ...
    <div class="d-flex justify-content-center mt-4">
        <a href="<?php echo e($loguin ? '/seleccionarEmpresa' : '/'); ?>" class="button button-secundary w-auto mx-1">Cancelar</a>
...
<?php /**PATH C:\Users\jpllinas\Documents\DesarrolloWEB\VPS-RUTAC\APP\rutadecrecimiento\resources\views/website/register/parciales/tipoRegistro.blade.php ENDPATH**/ ?>