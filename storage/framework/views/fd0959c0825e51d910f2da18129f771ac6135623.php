<footer class="<?php echo $__env->yieldContent('header-class'); ?>">
    ...
    <div class="wrap wrap-medium">
        <div class="footer">
            <div class="logo">
                <img src="<?php echo e(asset('storage/'.$footer->footer_logo_rutac)); ?>" alt="Ruta C Logo footer">
            </div>
            <div class="info">
                <ul>
                    <li>
                        <a href="https://www.ccsm.org" target="_blank" aria-label="Camara de comercio (opens in a new tab)">
                            <img src="<?php echo e(asset('storage/'.$footer->footer_logo_ally)); ?>" alt="Camara comercio">
                        </a>
                    </li>
                    <li class="textl">
                        ...
                        <span class="block font-s-small">Escribenos a <?php echo e($footer->footer_email_contact); ?></span>
        ...
        <div class="pp mt-40">
            <ul>
                <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <li>
                            <a class="font-s-small"  href="<?php echo e(asset('storage/'.$link->value)); ?>" target="_blank" aria-label="<?php echo e($link->name); ?> (opens in a new tab)"><?php echo e($link->name); ?></a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\Dir-CIDS\Documents\Repos\rutaCGitHUB\rutadecrecimiento\resources\views/website/layouts/footer.blade.php ENDPATH**/ ?>